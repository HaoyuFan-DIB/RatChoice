...
if __name__ == "__main__":
    data_path = '/media/zhemengwu/Gigantic Data/SingleContext_Hipp/FittedResult2'
    EXP_datapath = '/media/zhemengwu/Gigantic Data/SingleContext_Hipp/Data'
    plot_path = '/media/zhemengwu/Gigantic Data/SingleContext_Hipp/RePlot'
    if not os.path.exists(plot_path):
        os.mkdir(plot_path)

    for ratID in [1,2,3,9,10,12,13,16]:
        ...
        plt.savefig(os.path.join(plot_path, "Rat{n}_Accuracy.png".format(n=ratID)))
        plt.close()
        ...
        ax3.legend()
        ax3.grid()
        ax3.set_xlabel("Rat {id}".format(id=ratID))

        plt.savefig(os.path.join(plot_path, "Rat{n}_Network.png".format(n=ratID)))
        plt.close()
